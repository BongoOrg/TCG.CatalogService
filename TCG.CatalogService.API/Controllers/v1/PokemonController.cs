...
namespace TCG.CatalogService.API.Controllers.v1
{
    ...
    public class PokemonController : ControllerBase
    {
        ...
        public PokemonController(IMediator mediator, IMapper mapper, IPokemonExtApiHelper pokemonExtApiHelper)
        {
            _mediator = mediator;
            _mapper = mapper;
        ...
        /// <summary>
        /// Télécharger les cartes sur un Bucket
        /// </summary>
        /// <returns></returns>
        [HttpPost]
        ...
        /// <summary>
        /// Télécharger les cartes en local
        /// </summary>
        /// <returns></returns>
        // [HttpPost]
        ...
        //     {
        //         _pokemonExtApiHelper.DownloadPokemonCard(pokemon);
        //     }
        //
        //     return Ok();
        // }
